...
const exists = (num) => {
  if (num == 1) return !(props.spotify === "none");
  else if (num == 2) return !(props.youtube === "none");
  else if (num == 3) return !(props.apple === "none");
}
...
.mailbtn {
  margin: 0;
  padding: 0;
  background-image: url("../assets/Icons/email.webp");
